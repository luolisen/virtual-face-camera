...
import io.github.alanlaw.vfc.ui.*
import io.github.alanlaw.vfc.ui.theme.CamSwapTheme
...
class MainActivity : ComponentActivity(), App.ServiceStateListener {
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(io.github.alanlaw.vfc.utils.LocaleHelper.onAttach(newBase))
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        
        // Migrate legacy file markers and v0.1 global shortcut/audio settings
        // before starting any service that may read the shared config file.
        val configManager = ConfigManager(false)
        configManager.setContext(applicationContext)
        val migrated = configManager.migrateIfNeeded()
        val migratedV02 = configManager.migrateV02Configuration()
        if (migrated || migratedV02) {
