...
public class GLVideoRenderer implements SurfaceTexture.OnFrameAvailableListener {
    ...
    private void renderToBackBuffer(RenderTargetRole renderTargetRole) {
        ...
        float[] ambientColor = io.github.alanlaw.vfc.utils.ScreenColorDetector.INSTANCE.getAmbientColor();
        float ambientIntensity = io.github.alanlaw.vfc.utils.ScreenColorDetector.INSTANCE.getAmbientIntensity();
