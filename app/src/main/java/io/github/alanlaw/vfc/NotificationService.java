...
public class NotificationService extends Service {
    ...
    private static final String ACTION_PREV_INTERNAL = IpcContract.ACTION_NOTIFICATION_PREV;
    private static final String ACTION_NEXT_INTERNAL = IpcContract.ACTION_NOTIFICATION_NEXT;
    private static final String ACTION_ROTATE_INTERNAL = IpcContract.ACTION_NOTIFICATION_ROTATE;
    private static final String ACTION_EXIT_INTERNAL = IpcContract.ACTION_NOTIFICATION_EXIT;
