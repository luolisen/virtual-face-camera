...
public class AudioDataProvider {
    ...
    public static String getAudioFilePath() {
        ...
        String selectedAudio = VideoManager.getConfig().getString(
                io.github.alanlaw.vfc.ConfigManager.KEY_SELECTED_AUDIO, null);
        ...
        boolean forcePrivate = VideoManager.getConfig().getBoolean(
                io.github.alanlaw.vfc.ConfigManager.KEY_FORCE_PRIVATE_DIR, false);
        if (forcePrivate) {
            // 检查是否已经有私有目录的音频文件
            try {
            ...
            String publicDir = io.github.alanlaw.vfc.ConfigManager.DEFAULT_CONFIG_DIR;
